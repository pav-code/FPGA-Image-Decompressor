//coded by Jason Thong for CoE3DQ5 2016
//decoding of milestone 3 - read a .mic10 file, do lossless decoding, write a .sram_d2 file
...
int main(int argc, char **argv) {
	...
	if (argc<2) {
		printf("enter the input file name including the .mic10 extension: ");
		gets(input_filename);
	}
